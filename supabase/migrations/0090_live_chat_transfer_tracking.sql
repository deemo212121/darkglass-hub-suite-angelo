-- =====================================================================
-- 0090 — Live Chat: track who transferred a chat + a dedicated "Transferred" tab
--
...
-- marker, same spirit as escalated (migration 0080-adjacent) never
-- resetting itself either.
--
-- Run once in the Supabase SQL Editor, after 0089.
-- =====================================================================
