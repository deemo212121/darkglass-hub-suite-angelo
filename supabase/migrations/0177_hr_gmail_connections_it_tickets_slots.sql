-- =====================================================================
-- 0177 — Add 3 connectable Gmail slots for IT Tickets ('IT_1'/'IT_2'/
...
-- so widening it is the only schema change needed, same idiom as 0171.
--
-- Run once in the Supabase SQL Editor, after 0176.
-- =====================================================================
