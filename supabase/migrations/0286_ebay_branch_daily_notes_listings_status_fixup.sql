-- =====================================================================
-- 0286 — Safety net for ebay_branch_daily_notes.listings_status.
--
-- 0281 was edited in place to add this column while being iterated on,
-- but "create table if not exists" is a no-op against a table that
-- already exists — so if 0281 was run before that edit landed, the
