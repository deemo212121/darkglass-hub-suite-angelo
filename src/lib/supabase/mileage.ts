 ...
 * (migration 0128) an optional auto-sync path that derives entries from
...
export interface MileageEntry {
  ...
  /** The ticket's status AT SYNC TIME — a snapshot, not live; see migration 0143. */
  ticketStatus: string | null;
  source: "manual" | "auto";
  /** Payroll override set via the On Hold action — see migration 0144 and
...
export interface MileageSyncResult {
   ...
   *  null, technician_name: the raw ticket text — see migration 0134),
 ...
 * by migration 0128) are skipped rather than duplicated. Tickets with no
