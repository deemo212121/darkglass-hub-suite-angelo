  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const [
        ...
        supabase.from("profiles").select("id,display_name,username,role,assigned_branch,off_days,required_check_in,required_check_out,working_hours,meal_minutes").neq("role", "SUPERADMIN"),
